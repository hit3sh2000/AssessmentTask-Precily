                ...
                <div style={{ "display": "flex" }}>
                    <div >
                        <Resizable style={style}  >
                            <img src={`${imgdata.image1}`} alt="Image1 is coming from data base,So it may take time" style={{ "width": "100%", "height": "100%" }} />
                        </Resizable>
                    </div>
                    <div style={{ 'paddingInline': '10px' }} >
                        <Resizable style={style}  >
                            <img src={imgdata.image2} alt="Image2 is coming from data base,So it may take time" style={{ "width": "100%", "height": "100%" }} />
                        </Resizable>
                    </div>
                </div>
                <div>
                    <div >
                        <Resizable style={style} defaultSize={{ "width": "1100px", "height": "300px" }} >
                            <img src={imgdata.image3} alt="Image3 is coming from data base,So it may take time" style={{ "width": "100%", "height": "100%" }} />
                        </Resizable>
                    </div>
                </div>
            </Container>
